...
export const fetchArchivesFx = createEffect<void, AxiosResponse<ArchiveConfiguration[]>, AxiosError<AxiosResponseError>>(async () =>
  axios.get('/v1/internal/index/archive/list/paginated?pageSize=20&pageNumber=1'),
);
