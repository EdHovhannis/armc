...
interface AnalyticalEditorEmptyFormProps {
  message: string;
  captionButton: string;
  redirect(): any;
}

class AnalyticalEditorEmptyForm extends React.Component<AnalyticalEditorEmptyFormProps> {
  constructor(props) {
    super(props);
  }
...
export default AnalyticalEditorEmptyForm;
