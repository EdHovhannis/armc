...
import { SourcesPipeline } from '../../../store/pipeline/Types';
...
export interface KafkaSinkNodeItemProps {
...
export interface KafkaSinkNodeItemState {
  topic: string;
  projectShortName: string;
  currentNode?: ProcessingNode;
}

class KafkaSinkNodeItem extends React.Component<KafkaSinkNodeItemProps, KafkaSinkNodeItemState> {
  constructor(props) {
    super(props);
      ...
      <React.Fragment>
        ...
        >
          <ResizableBox width={750} className={classes.resizable}>
            ...
            <DialogContent>
              <DialogContentText>Выберите топик Kafka.</DialogContentText>
...
export default withStyles(styles)(KafkaSinkNodeItem);
