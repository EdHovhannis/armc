...
import { archiveIndexColumns } from './columns';
import * as styles from './styles.module.css';

export const ArchivesInstanceTable: FC<{
  data: ArchiveIndexRow[];
  tableKey: number;
}> = ({ data, tableKey }) => {
  ...
  const handleClearFilters = useCallback((table: DataGridTableInstance<ArchiveIndexRow>) => {
  ...
  const renderTopToolbar = useCallback(
    ({ table }: { table: DataGridTableInstance<ArchiveIndexRow> }) => (
      <>
