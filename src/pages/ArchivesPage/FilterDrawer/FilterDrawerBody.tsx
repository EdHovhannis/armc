...
import { $optionsArchiveLabel, $optionsArchiveName } from '@src/Entities/Archives/model';
...
const FilterDrawerBody: FC = () => {
  const [configurationOptions, projectOptions, labelOptions] = useUnit([$optionsArchiveName, $optionsProject, $optionsArchiveLabel]);
